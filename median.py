    ...
    def calculate_median(self, number_list):
        ...
        if len(number_list) > 1:
            ...
            if len(sorted_list) % 2 == 0:  # if mod 2 is 0 then list is of even length
                first_num = sorted_list[
                    (len(sorted_list) / 2) - 1]  # get number to the left side of the middle of the list
                second_num = sorted_list[
                    (len(sorted_list) / 2)]  # get number to the right side of the middle of the list
