...
#########SINGLE LIST VARIANCE TESTS##################
  ...
  #      @unittest.skip("Not yet Implemented")
        def test_calculate_variance_of_empty_list(self):
            ...
            variance_calc = VarianceCalc()
            self.assertIsNone(VarianceCalc.calculate_variance(variance_calc,[]),"Variance = None")
 ...
 #       @unittest.skip("Not yet Implemented")
        def test_calculate_variance_of_single_value_list(self):
            ...
            variable_list = [12]
            expected = 0
            actual = VarianceCalc.calculate_variance(variance_calc,variable_list)
...
#All DRV tests are to be skipped until implementation inside calculate_variance function
        ...
        def test_calculate_variance_of_DRV_empty_variable_list(self):
            ...
            actual = VarianceCalc.calculate_variance(variance_calc,variable_list,probability_list)
